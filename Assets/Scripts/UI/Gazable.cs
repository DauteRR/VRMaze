...
public abstract class Gazable : MonoBehaviour {
    ...
    /* Confirmation sound */
    private AudioSource confirmationSound;
    ...
    private void Awake() {
        ...
        confirmationSound = GetComponent<AudioSource>();
    ...
    public virtual void Update() {
        if (gazedAt && InputController.GetButtonUp(InputController.GetPS4ButtonName(actionButtonName))) {
